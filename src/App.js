...
const EditableTable = () => {
  ...
  const [katsayi1, setKatSayi1] = useState(6);
  const [katsayi2, setKatSayi2] = useState(6);
  const [katsayi3, setKatSayi3] = useState(6);
  const [katsayi4, setKatSayi4] = useState(6);
  const [katsayi5, setKatSayi5] = useState(6);
  ...
  return (
    <div class="h-screen font-sans  bg-gray-700">
      ...
      <div class="p-6 text-gray-900 whitespace-nowrap dark:text-white font-normal text-lg">
        ...
        <p>2.Enter the importances for all criteria (1-10)</p>
        <p>3.Enter points for each criteria of each school (1-10)</p>
